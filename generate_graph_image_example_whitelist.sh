...
echo "-importWhitelist=todo-area"
./_generate_graph_image.sh $GENERATE_MODE ./test/test-data/known-good-output/whitelist-and-sub-folders tslint.tslint-folders.json -subTitle="todo-area sub-folders [whitelist todo-area] (sub title)" -title="todo-area (title)" -importWhitelist=todo-area
